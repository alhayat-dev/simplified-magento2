...
class PluginSolution3
{
    ...
    public function beforeExecute(
        ...
        echo "Before execute sort order is 30" . PHP_EOL;
    }
    ...
    public function afterExecute(
        ...
        echo "After execute sort order is 30" . PHP_EOL;
        return $result;
    }
    ...
    public function aroundExecute(
        ...
        echo "Before proceed sort order is 30" . PHP_EOL;
        $proceed();
        echo "After proceed sort order is 30" . PHP_EOL;
    }
}
